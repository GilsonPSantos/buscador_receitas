package br.com.buscadorReceitas.cardapio.util;
...
public class ValidadoCardapio {
	...
	public void validar(Cardapio cardapio, String acao) throws ValidatorException, IOException, ValidationException {
		...
		try {
			...
			if(acao.equals("alterar")) {
				regra.setCampo(cardapio.getClass().getDeclaredField("idCardapio"));
			...
			if(acao.equals("inserir")) {
				regra = new Regra();
				regra.setCampo(cardapio.getClass().getDeclaredField("nome"));
				regra.setCampoNulo(false);
				regra.setNomeCampo(Propriedade.getMessageProperties(propertiesCampos, ConstanteCardapio.NOME_CAMPO_NOME_CARDAPIO));
			...
			valida.validarCampos(cardapio, listaRegras);
